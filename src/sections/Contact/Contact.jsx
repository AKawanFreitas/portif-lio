...
export default function Contact() {
  ...
  const handleSubmit = e => {
    ...
    const mailtoLink = `mailto:antonio@email.com?subject=Contato de ${form.name}&body=${encodeURIComponent(form.message)}%0A%0AResposta para: ${form.email}`
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.info}>
            <p className={styles.intro}>
              Estou aberto a novas oportunidades, colaborações ou apenas uma boa conversa
              sobre tecnologia. Entre em contato!
            </p>
          ...
          <form className={styles.form} onSubmit={handleSubmit}>
            ...
            <div className={styles.formGroup}>
              <label className={styles.formLabel} htmlFor="message">Mensagem</label>
              <textarea
                id="message"
                name="message"
